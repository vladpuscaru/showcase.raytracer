...
namespace Template
{
    public class OpenTKApp : GameWindow
    {
        ...
        public const bool rotationXActivated = false;
        public const bool rotationYActivated = true;
        ...
        // Shader files paths
        string shaderVertSource = Utils.GetPathFromSrc("shaders/screen_vs.glsl");
        string shaderFragSource = Utils.GetPathFromSrc("shaders/screen_fs.glsl");
        ...
        protected override void OnLoad()
        {
            ...
            {   // setting up a Modern OpenGL pipeline takes a lot of code
                ...
                // Vertex Shader
                string shaderSource = File.ReadAllText(shaderVertSource);
                ...
                // Fragment Shader
                shaderSource = File.ReadAllText(shaderFragSource);
